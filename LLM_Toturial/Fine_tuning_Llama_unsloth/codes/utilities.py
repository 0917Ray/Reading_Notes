...
def plot_lr(learning_rate_list, color="blue", save_path=None, info_text=None, figsize=(12, 5), alpha=0.9):
    ...
    plt.plot(steps, learning_rate_list, color=color, label='Learning Rate', linewidth=1.5, alpha=alpha)
    ...
    if info_text:
        plt.figtext(0.98, 0.04, info_text, 
            fontsize=7, 
            color='gray', 
            style='italic',
...
def plot_training_loss(loss_list, loss_step_list=None, color="blue", save_path=None, info_text=None, figsize=(12, 5), alpha=0.9):
    save_dir = os.path.dirname(save_path)
    if save_dir:
        os.makedirs(save_dir, exist_ok=True)
    ...
    plt.figure(figsize=figsize)
    plt.plot(loss_step_list, loss_list, color=color, label='Training Loss', linewidth=1.5, alpha=alpha)
...
def plot_training_val_loss(train_loss_list, val_loss_list, train_steps, val_steps, train_color="green", val_color="red", save_path=None, info_text=None, figsize=(12, 5), alpha=0.9):
    save_dir = os.path.dirname(save_path)
    if save_dir:
        os.makedirs(save_dir, exist_ok=True)
    ...
    plt.figure(figsize=figsize)
    plt.plot(train_steps, train_loss_list, color=train_color, label='Training Loss', linewidth=1.5, alpha=alpha)
    plt.plot(val_steps, val_loss_list, color=val_color, label='Validation Loss', linewidth=1.5, linestyle='-' , marker='o', markersize=4, alpha=alpha)
